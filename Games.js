...
* Use space button to launch an Ember attack on Badbots and wood blocks. (Note: This attack can destroy obstacles (Badbots and wooden blocks) in a line). For mobile users, use the button with letter E to launch the attack.
